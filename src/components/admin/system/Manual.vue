<template>
  <v-container>
    ...
    <v-layout row align-baseline>
      ...
      <v-card class="elevation-1 mt-3 ml-3 mx-auto" tile width="600">
        <v-card-title class="title">เพิ่มอาจารย์ให้นักศึกษา</v-card-title>
        <v-card-text>
          <v-menu>
            <template v-slot:activator="{ on }">
              <v-btn color="primary" outlined dark v-on="on" class="elevation-1"
          ...
          <v-layout>
            <v-list>
              <v-list-item>
                <v-list-item-title
                  >ปีการศึกษา:
                  {{ this.$store.getters.getSchoolYear }}</v-list-item-title
                >
              </v-list-item>
              ...
              <v-list-item>
                <v-list-item-title v-if="teach.text"
                  >อาจารย์: {{ teach.text }}</v-list-item-title
                >
